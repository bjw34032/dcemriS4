...
% \VignetteDepends{dcemriS4noNifti}
% \VignettePackage{dcemriS4noNifti}
...
\title{{\tt dcemriS4noNifti}: A Package for Medical Image Analysis}
...
The \pkg{dcemriS4noNifti} package requires incoming data to be in the
...
SDAM <- readNIfTI(system.file("nifti/SDAM_smooth.nii.gz", package="dcemriS4noNifti"))
