...
#' NIfTI data formats.
#' 
#' \tabular{ll}{ Package: \tab dcemriS4\cr Version: \tab 0.20.1\cr Date: \tab
#' 2009-09-02\cr Depends: \tab R (>= 2.6.0), grDevices, graphics, methods,
#' utils\cr Suggests: \tab bitops, minpack.lm, multicore, splines, XML\cr
#' License: \tab BSD\cr URL: \tab http://www.dcemri.org/,
#' http://dcemri.sourceforge.net/\cr }
#' 
#' Index: \preformatted{ R10.lm Estimate Intrinsic Tissue Relaxivity
#' [<--methods ~~ Methods for Function [<- in Package 'base' ~~ adc.lm Estimate
#' the Apparent Diffusion Coefficient (ADC) aif.orton.exp Arterial Input
#' Functions anlz Constructor for Analyze anlz-class Class "anlz" as.nifti
#' as.nifti audit.trail-methods Extract or Replace NIfTI Audit Trail
#' aux.file-methods Extract or Replace NIfTI/Analyze Auxiliary File buckley
#' Simulated Data from Buckley (2002) coerce,array,nifti-method Force an Object
#' to Belong to the NIfTI Class conv.fft Convolution of 3D Arrays using the
#' Fourier Transform convert.datatype Convert NIfTI Codes convert.datatype.anlz
#' Convert NIfTI Codes dam Double-Angle Method for B1+ Mapping dcemri.bayes
#' Bayesian Methods for Pharmacokinetic Modeling of Dynamic Contrast-Enhanced
#' MRI Data dcemri.info Facilitate the Creation and Modification of Audit
#' Trails dcemri.lm Pharmacokinetic Models for Dynamic Contrast-Enhanced MRI
#' Data dcemri.map Pharmacokinetic Modeling of Dynamic Contrast-Enhanced MRI
#' Data dcemri.spline Bayesian P-Splines for Dynamic Contrasat-Enhanced MRI
#' Data descrip-methods Extract or Replace NIfTI/Analyze Description
#' extract.aif Seed Growing for a 4D Array find.center Find the Center of a
#' Binary Mask ftm Fast Template Matching via Cross-Correlation hotmetal Hot
#' Metal Color Table image-methods Methods for Function 'image' in Package
#' 'dcemri' integerTranslation integerTranslation kineticModel Pharmacokinetic
#' Models nifti Constructor for NIfTI nifti-class Class "nifti"
#' niftiAuditTrail-class Class "niftiAuditTrail" niftiExtension-class Class
#' "niftiExtension" niftiExtensionSection-class Class "niftiExtensionSection"
#' ~~~ nsli Dimension Accessor Functions orthographic-methods ~~ Methods for
#' Function orthographic ~~ overlay-methods ~~ Methods for Function overlay ~~
#' performPermutation performPermutation quaternion2rotation Convert Quaternion
#' into a Rotation Matrix readANALYZE readANALYZE readNIfTI readNIfTI reorient
#' reorient shift3D Shift a 3D Array in One Dimension tim.colors Tim's Useful
#' Color Table translateCoordinate translateCoordinate writeANALYZE
#' writeANALYZE writeNIfTI writeNIfTI xyzt2space Bitwise Conversion Subroutines
#' }
#' 
...
#' @docType package
#' @author Brandon Whitcher <\email{bjw34032@@users.sourceforge.net}>\cr Volker
#' Schmid <\email{volkerschmid@@users.sourceforge.net}>\cr Andrew Thornton
